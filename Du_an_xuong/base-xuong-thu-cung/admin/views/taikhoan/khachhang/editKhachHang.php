                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Sửa thông tin tài khoản khach hàng: <?= $khachHang['ho_ten']; ?></h3>
                        </div>
                        ...
                        <form action="<?= BASE_URL_ADMIN . '?act=sua-khach-hang' ?>" method="post">
                            ...
                            <div class=" row card-body">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control" name="so_dien_thoai" value="<?= $khachHang['so_dien_thoai']; ?>" placeholder="Nhập email">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select id="inputStatus" name="gioi_tinh" class="form-control custom-select">
                                        <option <?= $khachHang['trang_thai'] == 1 ? 'selected' : '' ?> value="1">Nam</option>
                                        <option <?= $khachHang['trang_thai'] == 2 ? 'selected' : '' ?> value="2">Nữ</option>
